...
namespace Database {
    ...
    public partial class StudentDataSet : global::System.Data.DataSet {
        ...
        public partial class StudentDataTable : global::System.Data.TypedTableBase<StudentRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public StudentRow AddStudentRow(string ID, string Name, string Phone, string Address, System.DateTime inDate, string chk) {
        ...
        public partial class StudentRow : global::System.Data.DataRow {
            ...
            public System.DateTime inDate {
                get {
                    return ((global::System.DateTime)(this[this.tableStudent.inDateColumn]));
                }
                set {
                    this[this.tableStudent.inDateColumn] = value;
                }
            }
...
namespace Database.StudentDataSetTableAdapters {
    ...
    public partial class StudentTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [Student] WHERE (([ID] = @Original_ID) AND ([Name] = @Original_Name) " +
                "AND ([Phone] = @Original_Phone) AND ([Address] = @Original_Address) AND ([chk] =" +
                " @Original_chk) AND ([inDate] = @Original_inDate))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [Student] ([ID], [Name], [Phone], [Address], [chk], [inDate]) VALUES " +
                "(@ID, @Name, @Phone, @Address, @chk, @inDate);\r\nSELECT ID, Name, Phone, Address," +
                " chk, inDate FROM Student WHERE (ID = @ID)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [Student] SET [ID] = @ID, [Name] = @Name, [Phone] = @Phone, [Address] = @Address, [chk] = @chk, [inDate] = @inDate WHERE (([ID] = @Original_ID) AND ([Name] = @Original_Name) AND ([Phone] = @Original_Phone) AND ([Address] = @Original_Address) AND ([chk] = @Original_chk) AND ([inDate] = @Original_inDate));
SELECT ID, Name, Phone, Address, chk, inDate FROM Student WHERE (ID = @ID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Database.Properties.Settings.Default.STUDENTDATABASEConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT  ID, Name, Phone, Address, chk, inDate\r\nFROM     Student\r\nWHERE  (chk = \'N" +
                "\')";
            ...
            this._commandCollection[2].CommandText = "UPDATE Student\r\nSET        chk = \'Y\'\r\nWHERE  (ID = @ID); \r\nSELECT ID, Name, Phone" +
                ", Address, chk, inDate FROM Student WHERE (ID = @ID)";
            ...
            this._commandCollection[3].CommandText = "SELECT  ID, Name, Phone, Address, chk, inDate\r\nFROM     Student\r\n";
            this._commandCollection[3].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[4] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[4].Connection = this.Connection;
            this._commandCollection[4].CommandText = "SELECT  ID, Name, Phone, Address, chk, inDate\r\nFROM     Student\r\nWHERE  (chk = \'Y" +
                "\') AND (ID = @ID)";
            ...
            this._commandCollection[5].CommandText = "SELECT * FROM Student WHERE (ID=@ID) AND chk=\'N\'";
            ...
            this._commandCollection[6].CommandText = "SELECT  ID, Name, Phone, Address, chk, inDate\r\nFROM     Student\r\nWHERE  Name LIKE" +
                " @Name AND chk = \'N\'";
            ...
            this._commandCollection[7].CommandText = "INSERT INTO Student\r\n               (ID, Name, Phone, Address, chk, inDate)\r\nVALU" +
                "ES  (@ID,@Name,@Phone,@Address, \'N\', GETDATE()); \r\nSELECT ID, Name, Phone, Addre" +
                "ss, chk, inDate FROM Student WHERE (ID = @ID)";
            this._commandCollection[7].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[7].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@ID", global::System.Data.SqlDbType.NVarChar, 50, global::System.Data.ParameterDirection.Input, 0, 0, "ID", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._commandCollection[8].CommandText = "UPDATE Student\r\nSET        Name = @Name, Phone = @Phone, Address = @Address, inDa" +
                "te = GETDATE()\r\nWHERE  (ID = @ID);   \r\nSELECT ID, Name, Phone, Address, chk, inD" +
                "ate FROM Student WHERE (ID = @ID)";
            ...
            this._commandCollection[8].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@ID", global::System.Data.SqlDbType.NVarChar, 50, global::System.Data.ParameterDirection.Input, 0, 0, "ID", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, false)]
        public virtual int FillByExitID(StudentDataSet.StudentDataTable dataTable, string ID) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, false)]
        public virtual StudentDataSet.StudentDataTable GetDataByExitID(string ID) {
            this.Adapter.SelectCommand = this.CommandCollection[4];
            if ((ID == null)) {
                throw new global::System.ArgumentNullException("ID");
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, false)]
        public virtual int FillByID(StudentDataSet.StudentDataTable dataTable, string ID) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, false)]
        public virtual StudentDataSet.StudentDataTable GetDataByID(string ID) {
            this.Adapter.SelectCommand = this.CommandCollection[5];
            if ((ID == null)) {
                throw new global::System.ArgumentNullException("ID");
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, false)]
        public virtual int FillByName(StudentDataSet.StudentDataTable dataTable, string Name) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, false)]
        public virtual StudentDataSet.StudentDataTable GetDataByName(string Name) {
            this.Adapter.SelectCommand = this.CommandCollection[6];
            if ((Name == null)) {
                throw new global::System.ArgumentNullException("Name");
            }
        ...
        public virtual int Delete(string Original_ID, string Original_Name, string Original_Phone, string Original_Address, string Original_chk, System.DateTime Original_inDate) {
            if ((Original_ID == null)) {
            ...
            if ((Original_chk == null)) {
                throw new global::System.ArgumentNullException("Original_chk");
            }
            else {
                this.Adapter.DeleteCommand.Parameters[4].Value = ((string)(Original_chk));
            }
            this.Adapter.DeleteCommand.Parameters[5].Value = ((System.DateTime)(Original_inDate));
        ...
        public virtual int Insert(string ID, string Name, string Phone, string Address, string chk, System.DateTime inDate) {
            if ((ID == null)) {
                throw new global::System.ArgumentNullException("ID");
            }
            else {
            ...
            if ((chk == null)) {
                throw new global::System.ArgumentNullException("chk");
            }
            else {
                this.Adapter.InsertCommand.Parameters[4].Value = ((string)(chk));
            }
            this.Adapter.InsertCommand.Parameters[5].Value = ((System.DateTime)(inDate));
        ...
        public virtual int Update(string ID, string Name, string Phone, string Address, string chk, System.DateTime inDate, string Original_ID, string Original_Name, string Original_Phone, string Original_Address, string Original_chk, System.DateTime Original_inDate) {
            if ((ID == null)) {
                throw new global::System.ArgumentNullException("ID");
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[5].Value = ((System.DateTime)(inDate));
            if ((Original_ID == null)) {
                throw new global::System.ArgumentNullException("Original_ID");
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[11].Value = ((System.DateTime)(Original_inDate));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string Phone, string Address, string chk, System.DateTime inDate, string Original_ID, string Original_Name, string Original_Phone, string Original_Address, string Original_chk, System.DateTime Original_inDate) {
            return this.Update(Original_ID, Name, Phone, Address, chk, inDate, Original_ID, Original_Name, Original_Phone, Original_Address, Original_chk, Original_inDate);
        }
        ...
        public virtual int ExitID(string ID) {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int InsertQuery(string ID, string Name, string Phone, string Address) {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int UpdateQuery(string Name, string Phone, string Address, string ID) {
